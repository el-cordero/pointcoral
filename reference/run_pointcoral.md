...
Reads CPCe files/exports from a folder, matches images, validates
points, and writes analysis/ML-ready outputs. A crosswalk is optional.
Without one, `pointcoral` uses the raw labels already stored in the CPCe
files. With one, it standardizes those raw labels to full labels,
ecological classes, and custom ML classes.
...
- recursive:
  ...
  Whether to search `cpce_dir` recursively.
...
#> $paths
#> $paths$points_raw
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/tables/points_raw.csv"
#> 
#> $paths$points_clean
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/tables/points_clean.csv"
#> 
#> $paths$validation_report
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/tables/validation_report.csv"
#> 
#> $paths$crosswalk_check
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/tables/crosswalk_check.csv"
#> 
#> $paths$label_summary
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/qc/label_summary.csv"
#> 
#> $paths$image_summary
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/tables/image_summary.csv"
#> 
#> $paths$transect_summary
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/tables/transect_summary.csv"
#> 
#> $paths$site_summary
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/tables/site_summary.csv"
#> 
#> $paths$class_lookup
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/tables/class_lookup.csv"
#> 
#> $paths$labels
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/ml/labels.csv"
#> 
#> $paths$class_lookup
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/ml/class_lookup.csv"
#> 
#> $paths$labels_train
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/ml/labels_train.csv"
#> 
#> $paths$labels_val
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/ml/labels_val.csv"
#> 
#> $paths$labels_test
#> [1] "/tmp/RtmpLwJlKK/pointcoral-run-example/ml/labels_test.csv"
#> 
#> 
#> $points_raw
#> # A tibble: 200 × 36
